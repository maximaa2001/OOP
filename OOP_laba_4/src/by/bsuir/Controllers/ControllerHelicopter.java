...
public class ControllerHelicopter {
    ...
    public ControllerHelicopter() throws IOException {
        stage = new Stage();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../FXML/Helicopter.fxml"));
    ...
    void initialize() {
        ...
        btn_create_new.setOnMouseClicked(event -> {
            ...
            Controller.transports.add(new Helicopter(name,weight,max_speed,new Way(fromPoint,toPoint),count_engine,rotation_speed));
            stage.close();
        });
