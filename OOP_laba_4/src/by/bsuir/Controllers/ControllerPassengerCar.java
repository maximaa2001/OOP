...
public class ControllerPassengerCar {
    ...
    public ControllerPassengerCar() throws IOException {
        stage = new Stage();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../FXML/PassengerCar.fxml"));
    ...
    void initialize() {
        ...
        btn_create_new.setOnMouseClicked(event -> {
            ...
            Controller.transports.add(new PassengerCar(name,weight,max_speed,new Way(fromPoint,toPoint),volume_engine,count_passenger));
            stage.close();
        });
