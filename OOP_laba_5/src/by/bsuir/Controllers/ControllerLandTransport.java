...
public class ControllerLandTransport {
    ...
    public ControllerLandTransport() throws IOException {
        stage = new Stage();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../FXML/LandTransport.fxml"));
    ...
    void initialize() {
        ...
        btn_create_new.setOnMouseClicked(event -> {
            ...
            Controller.transports.add(new LandTransport(name,weight,max_speed,new Way(fromPoint,toPoint),volume_engine));
            stage.close();
        });
    }
}